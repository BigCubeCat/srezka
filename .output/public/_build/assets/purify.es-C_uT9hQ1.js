/*! @license DOMPurify 2.5.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.5.8/LICENSE */ function I(
  a,
) {
...
function le(a, n, o) {
  return (
    zt()
      ? (le = Reflect.construct)
      : (le = function (c, g, y) {
          var D = [null];
          D.push.apply(D, g);
          var x = Function.bind.apply(c, D),
            j = new x();
...
function Bt(a, n) {
  if (a) {
    ...
    if (
      (o === "Object" && a.constructor && (o = a.constructor.name),
      o === "Map" || o === "Set")
    )
      return Array.from(a);
...
var Kt = O(Array.prototype.forEach),
  ft = O(Array.prototype.pop),
  q = O(Array.prototype.push),
  se = O(String.prototype.toLowerCase),
  we = O(String.prototype.toString),
  ct = O(String.prototype.match),
  L = O(String.prototype.replace),
...
function O(a) {
  return function (n) {
    for (
      var o = arguments.length, s = new Array(o > 1 ? o - 1 : 0), c = 1;
      c < o;
      c++
    )
      s[c - 1] = arguments[c];
...
function U(a) {
  var n = qt(null),
    o;
  for (o in a) ue(jt, a, [o]) === !0 && (n[o] = a[o]);
  return n;
}
function ie(a, n) {
  for (; a !== null; ) {
...
var mt = E([
  ...
  oe = E(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]),
  rr = b(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
  ar = b(/<%[\w\W]*|[\w\W]*%>/gm),
  nr = b(/\${[\w\W]*}/gm),
  ir = b(/^data-[\-\w.\u00B7-\uFFFF]+$/),
  ...
  pr = function (n, o) {
    if (I(n) !== "object" || typeof n.createPolicy != "function") return null;
    var s = null,
    ...
    try {
      ...
      return (
        console.warn("TrustedTypes policy " + g + " could not be created."),
        null
      );
    }
  };
function _t() {
  var a = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : mr(),
    n = function (e) {
      return _t(e);
    };
  if (
    ((n.version = "2.5.8"),
    (n.removed = []),
    !a || !a.document || a.document.nodeType !== 9)
  )
    return (n.isSupported = !1), n;
  var o = a.document,
    s = a.document,
    c = a.DocumentFragment,
    g = a.HTMLTemplateElement,
    y = a.Node,
    D = a.Element,
    x = a.NodeFilter,
    j = a.NamedNodeMap,
    ht = j === void 0 ? a.NamedNodeMap || a.MozNamedAttrMap : j,
  ...
  var R = pr(K, o),
    ...
    J = s,
    pe = J.implementation,
    bt = J.createNodeIterator,
    Ot = J.createDocumentFragment,
    Rt = J.getElementsByTagName,
    Lt = o.importNode,
    ze = {};
  try {
  ...
  var de = rr,
    ...
    _e = lr,
    p = null,
    We = l({}, [].concat(M(mt), M(Ie), M(xe), M(ke), M(pt))),
    d = null,
    Be = l({}, [].concat(M(dt), M(Pe), M(Tt), M(oe))),
    f = Object.seal(
      Object.create(null, {
        tagNameCheck: {
          writable: !0,
    ...
    It = l({}, [te, re, w], we),
    P,
    xt = ["application/xhtml+xml", "text/html"],
    kt = "text/html",
    T,
    $ = null,
    ...
    Le = function (e) {
      ($ && $ === e) ||
        ...
        (e = U(e)),
        (P =
          xt.indexOf(e.PARSER_MEDIA_TYPE) === -1
            ? (P = kt)
            : (P = e.PARSER_MEDIA_TYPE)),
        (T = P === "application/xhtml+xml" ? we : se),
        (p = "ALLOWED_TAGS" in e ? l({}, e.ALLOWED_TAGS, T) : We),
        (d = "ALLOWED_ATTR" in e ? l({}, e.ALLOWED_ATTR, T) : Be),
        (Re = "ALLOWED_NAMESPACES" in e ? l({}, e.ALLOWED_NAMESPACES, we) : It),
        (be = "ADD_URI_SAFE_ATTR" in e ? l(U(Je), e.ADD_URI_SAFE_ATTR, T) : Je),
        (Ke = "ADD_DATA_URI_TAGS" in e ? l(U(Ze), e.ADD_DATA_URI_TAGS, T) : Ze),
        (W = "FORBID_CONTENTS" in e ? l({}, e.FORBID_CONTENTS, T) : qe),
        (Y = "FORBID_TAGS" in e ? l({}, e.FORBID_TAGS, T) : {}),
        (he = "FORBID_ATTR" in e ? l({}, e.FORBID_ATTR, T) : {}),
        (G = "USE_PROFILES" in e ? e.USE_PROFILES : !1),
        ($e = e.ALLOW_ARIA_ATTR !== !1),
        (Ee = e.ALLOW_DATA_ATTR !== !1),
        (je = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
        (Ye = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1),
        ...
        G &&
          ((p = l({}, M(pt))),
          (d = []),
          G.html === !0 && (l(p, mt), l(d, dt)),
          G.svg === !0 && (l(p, Ie), l(d, Pe), l(d, oe)),
          G.svgFilters === !0 && (l(p, xe), l(d, Pe), l(d, oe)),
          G.mathMl === !0 && (l(p, ke), l(d, Tt), l(d, oe))),
        e.ADD_TAGS && (p === We && (p = U(p)), l(p, e.ADD_TAGS, T)),
        e.ADD_ATTR && (d === Be && (d = U(d)), l(d, e.ADD_ATTR, T)),
        e.ADD_URI_SAFE_ATTR && l(be, e.ADD_URI_SAFE_ATTR, T),
        e.FORBID_CONTENTS &&
          (W === qe && (W = U(W)), l(W, e.FORBID_CONTENTS, T)),
        Se && (p["#text"] = !0),
        k && l(p, ["html", "head", "body"]),
        p.table && (l(p, ["tbody"]), delete Y.tbody),
        E && E(e),
        ($ = e));
    },
    et = l({}, ["mi", "mo", "mn", "ms", "mtext"]),
    tt = l({}, ["annotation-xml"]),
  ...
  var Ut = function (e) {
          ...
          : e.namespaceURI === te
            ? t.namespaceURI === w
              ...
              : t.namespaceURI === re
                ...
                : !!Me[r]
            : e.namespaceURI === w
              ? (t.namespaceURI === re && !tt[u]) ||
                (t.namespaceURI === te && !et[u])
                ? !1
                : !Me[r] && (Ft[r] || !ae[r])
              : !!(P === "application/xhtml+xml" && Re[e.namespaceURI])
        : !1;
    },
    S = function (e) {
    ...
    rt = function (e) {
      ...
      return (
        e && r && h.insertBefore(s.createTextNode(r), h.childNodes[0] || null),
        B === w ? Rt.call(t, k ? "html" : "body")[0] : k ? t.documentElement : h
      );
    },
    at = function (e) {
      return bt.call(
        ...
        x.SHOW_ELEMENT |
          x.SHOW_COMMENT |
          x.SHOW_TEXT |
          x.SHOW_PROCESSING_INSTRUCTION |
          x.SHOW_CDATA_SECTION,
        null,
        !1,
      );
    },
    ...
    nt = function (e) {
      var t;
      if (
        (C("beforeSanitizeElements", e, null),
        De(e) || _(/[\u0080-\uFFFF]/, e.nodeName))
      )
        return S(e), !0;
      var r = T(e.nodeName);
      if (
        (C("uponSanitizeElement", e, { tagName: r, allowedTags: p }),
        (e.hasChildNodes() &&
          !V(e.firstElementChild) &&
          (!V(e.content) || !V(e.content.firstElementChild)) &&
          _(/<[/\w]/g, e.innerHTML) &&
          _(/<[/\w]/g, e.textContent)) ||
          (r === "select" && _(/<template/i, e.innerHTML)) ||
          e.nodeType === 7 ||
          (Ae && e.nodeType === 8 && _(/<[/\w]/g, e.data)))
      )
        return S(e), !0;
      if (!p[r] || Y[r]) {
        if (
          !Y[r] &&
          ot(r) &&
          ((f.tagNameCheck instanceof RegExp && _(f.tagNameCheck, r)) ||
        ...
        if (Se && !W[r]) {
          ...
          if (A && u)
            for (var h = A.length, v = h - 1; v >= 0; --v) {
              var F = yt(A[v], !0);
              (F.__removalCount = (e.__removalCount || 0) + 1),
                u.insertBefore(F, gt(e));
            }
        }
        return S(e), !0;
      }
      return (e instanceof D && !Ut(e)) ||
        ...
        : (H &&
          ...
          C("afterSanitizeElements", e, null),
          !1);
    },
    it = function (e, t, r) {
      if (Xe && (t === "id" || t === "name") && (r in s || r in Pt)) return !1;
      if (!(Ee && !he[t] && _(Mt, t))) {
        if (!($e && _(Dt, t))) {
          if (!d[t] || he[t]) {
            if (
              !(
                (ot(e) &&
                  ((f.tagNameCheck instanceof RegExp && _(f.tagNameCheck, e)) ||
                    (f.tagNameCheck instanceof Function &&
                      f.tagNameCheck(e))) &&
                  ((f.attributeNameCheck instanceof RegExp &&
                    _(f.attributeNameCheck, t)) ||
      ...
      if (!(!h || De(e))) {
        ...
        for (A = h.length; A--; ) {
          ...
          var F = t,
            ...
            Ne = F.namespaceURI;
          if (
            ((r = m === "value" ? t.value : Jt(t.value)),
            (u = T(m)),
            (v.attrName = u),
            (v.attrValue = r),
            (v.keepAttr = !0),
            (v.forceKeepAttr = void 0),
            C("uponSanitizeAttribute", e, v),
            (r = v.attrValue),
            !v.forceKeepAttr && (ne(m, e), !!v.keepAttr))
          ) {
            if (!Ye && _(/\/>/i, r)) {
              ne(m, e);
              continue;
            ...
            H &&
              ((r = L(r, de, " ")), (r = L(r, Te, " ")), (r = L(r, ve, " ")));
            var st = T(e.nodeName);
            if (it(st, u, r)) {
              if (
                (Ve && (u === "id" || u === "name") && (ne(m, e), (r = Ct + r)),
                Ae && _(/((--!?|])>)|<\/(style|title)/i, r))
              ) {
                ne(m, e);
                continue;
              }
              if (
                R &&
                I(K) === "object" &&
                typeof K.getAttributeType == "function" &&
                !Ne
              )
              ...
              try {
                Ne ? e.setAttributeNS(Ne, m, r) : e.setAttribute(m, r),
                  De(e) ? S(e) : ft(n.removed);
              } catch {}
            }
          }
        }
    ...
    Ht = function i(e) {
      ...
      for (C("beforeSanitizeShadowDOM", e, null); (t = r.nextNode()); )
        C("uponSanitizeShadowNode", t, null),
          nt(t),
          lt(t),
          t.content instanceof c && i(t.content);
  ...
  return (
    (n.sanitize = function (i) {
      ...
      if (!n.isSupported) {
        if (
          I(a.toStaticHTML) === "object" ||
          typeof a.toStaticHTML == "function"
        ) {
          if (typeof i == "string") return a.toStaticHTML(i);
          if (V(i)) return a.toStaticHTML(i.outerHTML);
        }
        return i;
      }
      if (
        (ye || Le(e), (n.removed = []), typeof i == "string" && (X = !1), X)
      ) {
        if (i.nodeName) {
          var v = T(i.nodeName);
          if (!p[v] || Y[v])
        ...
        (t = rt("<!---->")),
          ...
          (r.nodeType === 1 && r.nodeName === "BODY") || r.nodeName === "HTML"
            ? (t = r)
            : t.appendChild(r);
      else {
        if (!z && !H && !k && i.indexOf("<") === -1)
          return R && ee ? R.createHTML(i) : i;
        if (((t = rt(i)), !t)) return z ? null : ee ? me : "";
      }
      t && ge && S(t.firstChild);
      for (var F = at(X ? i : t); (u = F.nextNode()); )
        (u.nodeType === 3 && u === A) ||
          (nt(u), lt(u), u.content instanceof c && Ht(u.content), (A = u));
      if (((A = null), X)) return i;
      if (z) {
        if (Q)
      ...
      return (
        k &&
          ...
          _(fr, t.ownerDocument.doctype.name) &&
          (m =
            "<!DOCTYPE " +
            t.ownerDocument.doctype.name +
            `>
` +
            m),
        H && ((m = L(m, de, " ")), (m = L(m, Te, " ")), (m = L(m, ve, " "))),
        R && ee ? R.createHTML(m) : m
      );
    }),
